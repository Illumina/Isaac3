...
This version is not commercially supported and provided as is under [PolyForm Strict License 1.0.0](https://github.com/Illumina/Isaac3/blob/master/COPYRIGHT)
