...
void align(const isaac::options::AlignOptions &options)
{
    ...
    {
        ISAAC_THREAD_CERR << "align: NUMA-aware memory management disabled." << std::endl;
    }

    const uint64_t availableMemory = options.memoryLimit * 1024 * 1024 * 1024;
