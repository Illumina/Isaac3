...
public:
    BinSorter(
        ...
        const isaac::reference::NumaContigLists &contigLists,
        const unsigned splitGapLength,
        const isaac::reference::NumaContigAnnotationsList &annotations) :
...
private:
    ...
    const isaac::reference::NumaContigAnnotationsList &annotations_;
    ...
    bool isAnchored(
        ...
        const isaac::reference::ContigAnnotation &annotation,
