...
public:
                             ...
                             clipSemialigned, barcodeMetadataList))
    {
        ...
        BOOST_FOREACH(const alignment::TemplateLengthStatistics &barcodeTls, barcodeTemplateLengthStatistics)
        {
            ISAAC_THREAD_CERR << "ParallelGapRealigner " << barcodeTls << std::endl;
        }
    }
