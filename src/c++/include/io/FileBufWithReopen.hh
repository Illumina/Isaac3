...
public:
     ...
     */
    __filebuf_type* reopen(const char* s, const std::size_t fallocateSize, FadviseFlags fadvise = normal)
    {
...
//        std::cerr << "reopening " << __s << " with mode " << openMode << "\n";
        ...
        if (result)
        {
            ...
            if (fallocateSize)
            {
                ...
                // with writing into a file. It can succeed as the fallocateSize is often a pessimisitic guess
