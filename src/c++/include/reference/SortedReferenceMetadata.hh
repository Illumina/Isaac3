...
{
public:
    static const unsigned OLDEST_SUPPORTED_REFERENCE_FORMAT_VERSION = 7;
    static const unsigned CURRENT_REFERENCE_FORMAT_VERSION = 8;
 ...
 */
inline std::vector<uint64_t> computeContigOffsets(const reference::SortedReferenceMetadata::Contigs &contigs)
{
    std::vector<uint64_t> ret(contigs.size());

    uint64_t lastOffset = 0UL;
