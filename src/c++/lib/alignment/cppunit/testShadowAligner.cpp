...
void TestShadowAligner::testRescueShadowShortest()
{
    ...
    ShadowAligner shadowAligner(true, flowcells, 8, 2, false, false, alignmentCfg, false);
    {
        const TemplateLengthStatistics tls(200, 400, 312, 38, 26, TemplateLengthStatistics::FRp, TemplateLengthStatistics::RFm, -1);
        const isaac::alignment::BclClusters bcl0(getBcl(readMetadataList, contigList, 0, 0, 0, false, true));
        Cluster cluster0(getMaxReadLength(readMetadataList));
        cluster0.init(readMetadataList, bcl0.cluster(0), 1101, 999, isaac::alignment::ClusterXy(0,0), true, 0, 0);
        FragmentMetadata fragment0, fragment1;
        isaac::alignment::FragmentMetadataList shadowList(50);
        ...
        CPPUNIT_ASSERT(shadowAligner.rescueShadow(contigList, contigAnnotations, fragment0, shadowList, readMetadataList[1], testAdapters, tls));
        ...
        fragment0 = fragment1;
        CPPUNIT_ASSERT(shadowAligner.rescueShadow(contigList, contigAnnotations, fragment1, shadowList, readMetadataList[0], testAdapters, tls));
    ...
    }
    {
        ...
        const isaac::alignment::BclClusters bcl0(getBcl(readMetadataList, contigList, 0, 109, 98, true, false));
        Cluster cluster0(getMaxReadLength(readMetadataList));
        cluster0.init(readMetadataList, bcl0.cluster(0), 1101, 999, isaac::alignment::ClusterXy(0,0), true, 0, 0);
        FragmentMetadata fragment0, fragment1;
        isaac::alignment::FragmentMetadataList shadowList(50);
...
void TestShadowAligner::testRescueShadowLongest()
{
    ...
    ShadowAligner shadowAligner(true, flowcells, 8, 2, false, false, alignmentCfg, true);
    {
        const TemplateLengthStatistics tls(200, 400, 312, 38, 26, TemplateLengthStatistics::FRp, TemplateLengthStatistics::RFm, -1);
        const isaac::alignment::BclClusters bcl0(getBcl(readMetadataList, contigList, 4, 0, 12, false, true));
        Cluster cluster0(getMaxReadLength(readMetadataList));
        cluster0.init(readMetadataList, bcl0.cluster(0), 1101, 9199, isaac::alignment::ClusterXy(0,0), true, 0, 0);
        FragmentMetadata fragment0, fragment1;
        isaac::alignment::FragmentMetadataList shadowList(50);
        fragment0.cluster = &cluster0;
        fragment0.readIndex = 0;
    ...
    {
        const TemplateLengthStatistics tls(200, 400, 312, 38, 26, TemplateLengthStatistics::FRm, TemplateLengthStatistics::RFp, -1);
        const isaac::alignment::BclClusters bcl0(getBcl(readMetadataList, contigList, 4, 341, 318, true, false));
        Cluster cluster0(getMaxReadLength(readMetadataList));
        cluster0.init(readMetadataList, bcl0.cluster(0), 1101, 999, isaac::alignment::ClusterXy(0,0), true, 0, 0);
        FragmentMetadata fragment0, fragment1;
        isaac::alignment::FragmentMetadataList shadowList(50);
