    ...
    FragmentMetadata &fragmentMetadata)
{
    ...
    if (Cigar::ALIGN == operation.second)
    {
        ...
        const reference::Contig &reference = contigList.at(fragmentMetadata.contigId);
        reference::Contig::const_iterator referenceBegin = reference.begin() + fragmentMetadata.position;
    ...
    FragmentMetadata &fragmentMetadata)
{
    ...
    if (Cigar::ALIGN == operation.second)
    {
        ...
        const reference::Contig &reference = contigList.at(fragmentMetadata.contigId);
        std::reverse_iterator<reference::Contig::const_iterator> referenceRBegin(reference.begin() + fragmentMetadata.position +
