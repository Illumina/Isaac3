...
#ifdef HAVE_FCNTL_H
#include <fcntl.h>
#else // #ifdef HAVE_FCNTL_H
#error The header <fcntl.h> is required.
#endif // #ifdef HAVE_FCNTL_H

#ifdef HAVE_LINUX_FALLOC_H
#include <linux/falloc.h>
#else // #ifdef HAVE_LINUX_FALLOC_H
#error The header <linux/falloc.h> is required.
    ...
    const bool disableFastbins)
{
    if (disableMultipleArenas)
    {
        ...
        // time doing something other than memory allocation/deallocation, having more than one arena is purely a waste
